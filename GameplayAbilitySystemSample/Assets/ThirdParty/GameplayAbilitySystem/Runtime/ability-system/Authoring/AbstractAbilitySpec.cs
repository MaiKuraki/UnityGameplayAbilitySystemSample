...
namespace AbilitySystem.Authoring
{
    ...
    public abstract class AbstractAbilitySpec
    {
        ...
        public AbstractAbilitySpec(AbstractAbilityScriptableObject ability, AbilitySystemComponent owner)
        {
        ...
        protected virtual bool AscHasAllTags(AbilitySystemComponent asc, GameplayTagScriptableObject[] tags)
        {
        ...
        protected virtual bool AscHasNoneTags(AbilitySystemComponent asc, GameplayTagScriptableObject[] tags)
        {
            // If the input ASC is not valid, assume check passed
            if (!asc) return true;
