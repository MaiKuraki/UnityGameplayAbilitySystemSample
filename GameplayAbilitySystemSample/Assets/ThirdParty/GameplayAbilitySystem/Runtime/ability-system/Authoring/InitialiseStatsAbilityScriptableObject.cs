...
namespace AbilitySystem.Authoring
{
    ...
    public class InitialiseStatsAbilityScriptableObject : AbstractAbilityScriptableObject
    {
        ...
        public override AbstractAbilitySpec CreateSpec(AbilitySystemComponent owner)
        {
        ...
        {
            public InitialiseStatsAbility(AbstractAbilityScriptableObject abilitySO, AbilitySystemComponent owner) : base(abilitySO, owner)
            {
            }
