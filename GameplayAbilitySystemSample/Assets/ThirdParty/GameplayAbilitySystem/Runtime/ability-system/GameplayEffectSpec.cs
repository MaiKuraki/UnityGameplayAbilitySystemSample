...
namespace AbilitySystem
{
    ...
    public class GameplayEffectSpec
    {
        ...
        public static GameplayEffectSpec CreateNew(GameplayEffectScriptableObject GameplayEffect, AbilitySystemComponent Source, float Level = 1)
        {
            return new GameplayEffectSpec(GameplayEffect, Source, Level);
        }

        private GameplayEffectSpec(GameplayEffectScriptableObject GameplayEffect, AbilitySystemComponent Source, float Level = 1)
        {
        ...
        public GameplayEffectSpec SetTarget(AbilitySystemComponent target)
        {
            this.Target = target;
            return this;
        }
