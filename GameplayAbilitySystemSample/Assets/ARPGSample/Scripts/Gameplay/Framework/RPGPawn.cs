...
{
    public class RPGPawn : Pawn
    {
        private static readonly string DEBUG_FLAG = "[RPGPawn]";
        ...
        private GameMode GM;
        private CMRPGPlayerState savedPS;
        ...
        public AnimationFSM AnimationFsm => animationFsm;
        ...
        public override void PossessedBy(Controller NewController)
        {
            ...
            savedPS = NewController.GetPlayerState<CMRPGPlayerState>();
