/// Code source: https://github.com/MohitSethi99/SpringArmComponent/blob/main/Assets/SpringArm/Scripts/SpringArm.cs
/// Latest commit 8592973 on Apr 21, 2022
using UnityEngine;
...
namespace CycloneGames.Gameplay
{
    ...
    public class SpringArm : MonoBehaviour
    {
        ...
        [Range(2, 20)] public int collisionTestResolution = 4;
        ...
        [Range(1f, 10f)] public float springArmLineWidth = 6f;
        ...
        private void Update()
        {
            ...
            transform.position = Vector3.SmoothDamp(transform.position, target.position + targetOffset,
                ref moveVelocity, movementSmoothTime);
        }
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            if (showCollisionProbe)
                Handles.SphereHandleCap(0, socketPosition, Quaternion.identity, 2 * collisionProbeSize,
                    EventType.Repaint);
        }
#endif
        ...
        private void SetSocketTransform()
        {
            ...
            foreach (Transform child in trans)
                child.position = Vector3.SmoothDamp(child.position, socketPosition, ref collisionTestVelocity,
                    collisionSmoothTime);
        }
